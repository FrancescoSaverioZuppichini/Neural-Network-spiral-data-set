...
Since it was not clear what to plot, we decided to plot five boundaries for the five learning rates used in section 2.4.2. We used 20k iterations that are more than enough to make each model converge to a good solution. Figure \ref{fig: learning_rate_boundary} shows the results
\begin{figure}
	\label{fig: learning_rate_boundary}
	\includegraphics[scale=0.5]{images/NN_boundary_vs_learning_rates/0,1}
	\includegraphics[scale=0.5]{images/NN_boundary_vs_learning_rates/0,01}
	\includegraphics[scale=0.5]{images/NN_boundary_vs_learning_rates/0,002}
	\includegraphics[scale=0.5]{images/NN_boundary_vs_learning_rates/0,001}
	\centering
	\includegraphics[scale=0.5]{images/NN_boundary_vs_learning_rates/0,0001}

	\caption{model boundary vs learning rates}
\end{figure}
Figure \ref{grad_vs_eta} and Figure \ref{eq: costs_vs_eta} shows differents eta vs gradients and errors respectively

\begin{figure}
\centering
\label{fig: grad_vs_eta}
\includegraphics[scale=0.6]{images/NN_boundary_vs_learning_rates/grads}

\end{figure}
\begin{figure}
\centering
\label{fig: costs_vs_eta}
\includegraphics[scale=0.6]{images/NN_boundary_vs_learning_rates/costs}
...
\subsection{Results}
Figure \ref{fig: results_boundary} shows the boundary of our new model with one of the best seed: \texttt{1508255316}.
\begin{figure}[H]
\label{fig: results_boundary}
\centering
\includegraphics[scale=0.6]{images/competition/competition_1508255316.png}	
...
\begin{python}
    ...
    model.train(train_X, train_T ,8000, { 'eta' : 0.1, 'beta' : 0.5 },'adagrad')
\end{python}
...
\caption{BetterNeuralNetwork vs Neural Netwotk}
\end{figure}
