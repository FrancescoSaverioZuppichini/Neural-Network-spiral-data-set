...
\texttt{BetterNeuralNetwork} also has \texttt{train} method that performs forward, backpropagation and weight updates directly. It accepts as input the training sets, the targets, max iterations, a dictionary containing the parameters and the update method name, the supported ones are: \texttt{'gradient\_descent'} (default), \texttt{'momentum'} and \texttt{'adagrad'}\subsection{Initial weight and bias}
...
\label{fig:momentum}
\centering
\includegraphics[scale=0.35]{images/momentum_plot_0,1.png}	
\includegraphics[scale=0.35]{images/momentum_plot_0,01.png}	
...
\end{figure}
In the \texttt{BetterNeuralNetwork} momentum can be enabled by passing the correct parameters and type to the \tetxttt{train} method. The following snippet shows and example
...
\subsection{Adagrad}
We also implemented Adagrad in order to speed up the convergence. In Figure \ref{fig: adagrad}, we can see the converge rate of a classic gradient descent versus adagrad for different step sizes.
\begin{figure}[H]
\label{fig: adagrad}
\centering
\includegraphics[scale=0.35]{images/adagrad_plot_0,1.png}	
\includegraphics[scale=0.35]{images/adagrad_plot_0,01.png}	
\includegraphics[scale=0.35]{images/adagrad_plot_0,001.png}	
\includegraphics[scale=0.35]{images/adagrad_plot_0,0001.png}	
